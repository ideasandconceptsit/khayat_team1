...
import 'package:team1_khayat/features/profile/view/widget/payment_methods_builder.dart';
    ...
    return ListView(
      ...
      children: [
        ProfileOption(
            ...
            subtitle: AppStrings.alreadyHaveOrders.tr,
            onTap: () {
              NavigationService.navigateToNamed(Routes.myOrderView,
                  arguments: null);
            }),
        ProfileOption(
          title: AppStrings.shippingAddresses.tr,
          subtitle: AppStrings.numAddresses.tr,
          onTap: () {
            NavigationService.navigateToNamed(Routes.shippingAddressPage,
                arguments: null);
          },
        ),
        ...
        ProfileOption(
          ...
          subtitle: AppStrings.youHaveSpecialPromoCodes.tr,
          onTap: () {
        ...
        ProfileOption(
          ...
          subtitle: AppStrings.reviewsForItems.tr,
          onTap: () {
        ...
        ProfileOption(
            ...
            subtitle:
                '${AppStrings.notifications.tr} _ ${AppStrings.password.tr}',
            onTap: () {
              NavigationService.navigateToNamed(Routes.settingView,
                  arguments: null);
            }),
      ],
    );
