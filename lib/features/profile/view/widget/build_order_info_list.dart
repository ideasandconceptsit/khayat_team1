      ...
      children: [
         Divider(color: AppColors.grey),
                  const SizedBox(height: 10),
                   Text(AppStrings.orderInformation,style:  AppTextStyles.tajawaltextStyle14,),
                  const SizedBox(height: 10),
                  ...
                  const OrderInfo(title: AppStrings.discount, value: '10%, Personal promo code'),
                   OrderInfo(title: AppStrings.totalAmount, value:'${order!.totalPrice}\$', isBold: true),
                    ...
                    children: [
                      Expanded(
                        child: OutlinedButton(
                          ...
                          onPressed: () {},
                          child: const Text(AppStrings.reorder, style: TextStyle(color: AppColors.blackColor)),
                        ),
                      ),
